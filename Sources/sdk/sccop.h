...
#define SCCOPT_CCFLEX_REMOVECURRENTPOINT                    86      /* TRUE to remove references to current point in vector output              */
...
#define SCCOPT_GRAPHIC_WATERMARK_FUTURE1                    123
#define SCCOPT_GRAPHIC_WATERMARK_FUTURE2                    124
#define SCCOPT_GRAPHIC_WATERMARK_FUTURE3                    125
#define SCCOPT_GRAPHIC_WATERMARK_FUTURE4                    126
/*  Skip 127 here because it is used elsewhere for an option acutally in use  .  */
#define SCCOPT_GRAPHIC_WATERMARK_FUTURE5                    128
...
#define SCCUT_MAX_OPTIONTRACK       121
