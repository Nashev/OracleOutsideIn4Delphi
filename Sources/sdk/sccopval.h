...
#define SCCGRAPHIC_MAX_SANE_BITMAP_DPI  		2400		/* Maximum reasonable bit map DPI... for sanity checking images */
...
#define SCCGRAPHIC_WATERMARK_POSITION_TOPLEFT			0
#define SCCGRAPHIC_WATERMARK_POSITION_TOPMIDDLE			1
#define SCCGRAPHIC_WATERMARK_POSITION_TOPRIGHT			2
#define SCCGRAPHIC_WATERMARK_POSITION_CENTERLEFT		3
#define SCCGRAPHIC_WATERMARK_POSITION_CENTERMIDDLE		4
#define SCCGRAPHIC_WATERMARK_POSITION_CENTERRIGHT		5
#define SCCGRAPHIC_WATERMARK_POSITION_BOTTOMLEFT		6
#define SCCGRAPHIC_WATERMARK_POSITION_BOTTOMMIDDLE		7
#define SCCGRAPHIC_WATERMARK_POSITION_BOTTOMRIGHT		8
...
#define SCCDOCUMENTMEMORYMODE_SMALL     2     /* 16MB  <- Default value (current setting, as of 8.2.2) */
#define SCCDOCUMENTMEMORYMODE_MEDIUM    3     /* 64MB */
#define SCCDOCUMENTMEMORYMODE_LARGE     4     /* 256MB <- This was how it was set in 8.2.0 */
...
#define SCCUT_WPFLAGS_EMAILMASK					0x00000001
/* depreciating SCCUT_WPFLAGS_STANDARDMIMEHEADER*, but leaving it for backward compatibility */
#define SCCUT_WPFLAGS_STANDARDMIMEHEADER        0x00000002
#define SCCUT_WPFLAGS_STANDARDEMAILHEADER       0x00000002
...
#define SCCUT_FITMODE_ORIGINAL					1
...
#define SCCUT_PRINTASPECT_ORIGINAL				1
...
#define CCFLEX_FORMATOPTIONS_REMOVECURRENTPOINT     0x00000400  /* Remove references to current point in vector output */
